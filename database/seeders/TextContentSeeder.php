...
class TextContentSeeder extends Seeder
{
  ...
  public function run()
  {
    DB::table('textcontent')->insert(
      ...
      ',
          'description' => "Informs the participant of the activity description."
        ],
      ]);
  }
}
