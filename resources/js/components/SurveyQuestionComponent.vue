    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="btn-group">
            <button class="btn btn-primary" v-on:click="newSurveyQuestion">
              New
            </button>
          </div>
        </div>
...
export default {
  ...
  created() {
    axios.get("/admin/surveyquestions").then((response) => {
  ...
  methods: {
    ...
    removeSurveyQuestion(id) {
      axios.delete("/admin/removeSurveyQuestion/" + id).then((response) => {
