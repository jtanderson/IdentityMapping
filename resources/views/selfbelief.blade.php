...
<div class="row mb-4">
    <div class="col-sm mb-4">
        @php
        echo getTextContent('self-belief-top-1');
        @endphp
    </div>
</div>

<form id="selfBelief">
    @foreach ($selfbeliefquestions as $number => $question)
    @if ( $number % 2 == 0 )
    <div class="row">
        <div class="col-sm">
            <div class="card-deck">
...
<script>
    window.onload = function() {
        var form = document.getElementById("selfBelief");
        ...
        form.addEventListener("change", function(evt) {
            ...
            $.post("/saveSelfBeliefAnswer", data).done(function(
                response
            ) {});
        });
    };
